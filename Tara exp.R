...
setwd("C:/Users/PrevBeast/Documents/R/Tara bio")
data_raw <- 
  read.csv("Tara round 2 all peptides.csv")
...
gene_df <- read.csv('Tara round 2 gene list.csv')
...
write.csv(protein, "Tara protein top3 no norm round 2.csv")
write.csv(data, "Tara peptides no norm round 2.csv")
write.csv(norm_value, "sums round 2.csv")
