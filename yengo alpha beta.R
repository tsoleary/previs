...
data_raw <- 
  read.csv("Alpha Beta Heart Failure all peptides.csv")
...
gene_df <- read.csv('Alpha Beta gene list.csv')
...
write.csv(protein, "Alpha Beta shared myosin norm proteins.csv")
write.csv(data, "Alpha Beta no norm all peptides.csv")
