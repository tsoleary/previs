...
setwd("C:/Users/PrevBeast/Documents/R/Taylor/Rabbit")
data_raw <- 
  read.csv("Rabbit Taylor Dec 2021 plus MyBPC2 all peptides.csv")
...
mhc_shared <- "G1SJN7; Q28641; G1SJQ4"
...
gene_df <- read.csv('Rabbit Taylor Dec 2021 plus MyBPC2 gene list.csv')
...
write.csv(protein, "Rabbit Top3 Shared Myh norm proteins plus MyBPC2.csv")
