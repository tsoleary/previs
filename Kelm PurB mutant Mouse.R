...
setwd("C:/Users/PrevBeast/Documents/R/Kelm")
data_raw <- 
  read.csv("PurB Test All Peptides.csv")

# Normalization ----------------------------------------------------------------

ctrl_raw <- grep("WT", colnames(data_raw))
...
gene_df <- read.csv('PurB Test genelist.csv')
...
write.csv(protein, "Top3 Sumtot norm proteins.csv")
write.csv(data, "Top3 Sumtot norm peptides.csv")
