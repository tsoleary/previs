...
setwd("C:/Users/PrevBeast/Documents/R/Carol Bookwalter")
data_raw <- read.csv("JM and CB MyoK Bands all peptides.csv")
...
gene_df <- read.csv('JM and CB MyoK Bands genelist.csv')
...
write.csv(protein, "Top3 Non norm proteins JM and CB.csv")
write.csv(data, "No norm All JM and CB.csv")
