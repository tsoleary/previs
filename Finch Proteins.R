...
data_raw <- 
  read.csv("T guttata Iris FASTAs and Histones only All Peptides.csv")
...
gene_df <- read.csv('T guttata Iris FASTAs and Histones only Gene List simple.csv')
...
write.csv(protein, "110620 H4 norm proteins by Top3 no singlequote.csv")
# write.csv(specialprotein, "H4 norm protein watchlist by Top3.csv")
write.csv(data, "110620 H4 Norm all peptides Top5 simple gene.csv")
