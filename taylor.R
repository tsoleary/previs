...
setwd("C:/Users/PrevBeast/Documents/R/Taylor")
data_raw <- 
  read.csv("taylor_drosophila_all_peptides.csv")
...
group_names <- colnames(data_top)[grep("F", colnames(data_top))]
...
gene_df <- read.csv('taylor_drosophila_gene_names.csv')
...
write.csv(protein, "taylor_drosophila_thick_filament_r.csv")