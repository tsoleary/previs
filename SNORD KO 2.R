...
data_raw <- 
  read.csv("6wk and 12wk Ventricles all peps.csv")
...
gene_df <- read.csv('6wk and 12wk Ventricles Gene list.csv')
...
write.csv(protein, "6wk and 12wk Top3 Sumtotal norm proteins.csv")
