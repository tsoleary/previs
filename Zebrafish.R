...
setwd("C:/Users/PrevBeast/Documents/R/Zebrafish 1219")
data_raw <- 
  read.csv("Zebrafish one larva signal tests Jan 2020 no TSO all peptides.csv")
...
# gene_df <- read.csv('Zebrafish one larva signal tests Jan 2020 no TSO Gene list.csv')
# 
...
write.csv(data_top, "ZF singles Jan 2020 top 5 only.csv")
