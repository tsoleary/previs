...
setwd("C:/Users/PrevBeast/Documents/R/Shane")
data_raw <- 
  read.csv("Shane_lightchain_myBPC_phosphorylation_before_after_pool_all_peptides.csv")
...
# csv of just peptides 

write.csv(data, "Shane_phosphorylation_study_all_peptides_sum_total_norm.csv", row.names = FALSE)
...
gene_df <- read.csv('rat_fasta_accession_gene.csv')
